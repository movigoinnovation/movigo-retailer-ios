...
class RPrivacyPolicyScreen extends StatefulWidget {
  const RPrivacyPolicyScreen({super.key});

  @override
  State<RPrivacyPolicyScreen> createState() => _RPrivacyPolicyScreenState();
}

class _RPrivacyPolicyScreenState extends State<RPrivacyPolicyScreen> {
  @override
