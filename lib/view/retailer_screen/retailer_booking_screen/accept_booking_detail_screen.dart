...
import 'driver_eta_banner.dart';

class RAcceptBookingDetailScreen extends StatefulWidget {
  final Map<String, dynamic>? bookingData;
  const RAcceptBookingDetailScreen({super.key, this.bookingData});

  @override
  State<RAcceptBookingDetailScreen> createState() =>
      _RAcceptBookingDetailScreenState();
}

class _RAcceptBookingDetailScreenState
    extends State<RAcceptBookingDetailScreen> {
  @override
  void initState() {
    super.initState();
