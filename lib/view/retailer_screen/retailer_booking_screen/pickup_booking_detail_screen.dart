...
class RPickupBookingDetailScreen extends StatefulWidget {
  final Map<String, dynamic>? bookingData;
  const RPickupBookingDetailScreen({super.key, this.bookingData});

  @override
  State<RPickupBookingDetailScreen> createState() =>
      _RPickupBookingDetailScreenState();
}

class _RPickupBookingDetailScreenState
    extends State<RPickupBookingDetailScreen> {
  @override
  void initState() {
    super.initState();
