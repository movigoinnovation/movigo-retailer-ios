...
class ArrivedBookingDetailScreen extends StatefulWidget {
  const ArrivedBookingDetailScreen({super.key});

  @override
  State<ArrivedBookingDetailScreen> createState() =>
      _ArrivedBookingDetailScreenState();
}

class _ArrivedBookingDetailScreenState
    extends State<ArrivedBookingDetailScreen> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLanguage.arrivedText[language],
                          style: TextStyle(
                              fontSize: 14,
  ...
  void _showCancelPopup(BuildContext context) {
    ...
    showMenu(
      ...
      position: RelativeRect.fromLTRB(
        ...
        kToolbarHeight + 50, 0, // no right gap
        overlay.size.height,
      ),
      items: [
        PopupMenuItem(
