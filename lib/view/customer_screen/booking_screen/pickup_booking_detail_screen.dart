...
class PickupBookingDetailScreen extends StatefulWidget {
  const PickupBookingDetailScreen({super.key});

  @override
  State<PickupBookingDetailScreen> createState() =>
      _PickupBookingDetailScreenState();
}

class _PickupBookingDetailScreenState extends State<PickupBookingDetailScreen> {
  @override
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        AppLanguage.pickuptText[language],
                        style: TextStyle(
                            fontSize: 14,
