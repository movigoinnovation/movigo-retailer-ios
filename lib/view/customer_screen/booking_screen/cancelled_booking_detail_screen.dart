...
class CancelledBookingDetailScreen extends StatefulWidget {
  const CancelledBookingDetailScreen({super.key});

  @override
  State<CancelledBookingDetailScreen> createState() =>
      _CancelledBookingDetailScreenState();
}

class _CancelledBookingDetailScreenState
    extends State<CancelledBookingDetailScreen> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLanguage.mySchText[language],
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          fontFamily: AppFont.fontFamily,
